      ...
      body: ListView(
        ...
        children: [
          ...
          _uploadRow(
            ...
            onUpload: (_saving || !widget.appState.isRunning) ? null : () async => _uploadAndSet(api, kind: _MediaKind.avatar),
          ),
          const SizedBox(height: 12),
          ...
          _uploadRow(
            ...
            onUpload: (_saving || !widget.appState.isRunning) ? null : () async => _uploadAndSet(api, kind: _MediaKind.banner),
          ),
