...
class CoreConfig {
  ...
  CoreConfig copyWith({
    ...
    List<String>? apRelays,
    List<String>? bootstrapFollowActors,
    String? displayName,
    String? summary,
    String? iconUrl,
    ...
    String? previousPublicBaseUrl,
    String? previousRelayToken,
    int? upnpPortRangeStart,
    int? upnpPortRangeEnd,
    int? upnpLeaseSecs,
    int? upnpTimeoutSecs,
    String? postDeliveryMode,
    int? p2pRelayFallbackSecs,
    int? p2pCacheTtlSecs,
    bool? useTor,
    String? proxyHost,
    int? proxyPort,
    ...
    return CoreConfig(
      ...
      relayWs: relayWs ?? this.relayWs,
      relayToken: relayToken ?? this.relayToken,
      bind: bind ?? this.bind,
      internalToken: internalToken ?? this.internalToken,
      apRelays: apRelays ?? this.apRelays,
      bootstrapFollowActors: bootstrapFollowActors ?? this.bootstrapFollowActors,
      displayName: displayName ?? this.displayName,
      summary: summary ?? this.summary,
      iconUrl: iconUrl ?? this.iconUrl,
      iconMediaType: iconMediaType ?? this.iconMediaType,
      imageUrl: imageUrl ?? this.imageUrl,
      imageMediaType: imageMediaType ?? this.imageMediaType,
      profileFields: profileFields ?? this.profileFields,
      manuallyApprovesFollowers: manuallyApprovesFollowers ?? this.manuallyApprovesFollowers,
      blockedDomains: blockedDomains ?? this.blockedDomains,
      blockedActors: blockedActors ?? this.blockedActors,
      previousPublicBaseUrl: previousPublicBaseUrl ?? this.previousPublicBaseUrl,
      previousRelayToken: previousRelayToken ?? this.previousRelayToken,
      upnpPortRangeStart: upnpPortRangeStart ?? this.upnpPortRangeStart,
      upnpPortRangeEnd: upnpPortRangeEnd ?? this.upnpPortRangeEnd,
      upnpLeaseSecs: upnpLeaseSecs ?? this.upnpLeaseSecs,
      upnpTimeoutSecs: upnpTimeoutSecs ?? this.upnpTimeoutSecs,
      postDeliveryMode: postDeliveryMode ?? this.postDeliveryMode,
      p2pRelayFallbackSecs: p2pRelayFallbackSecs ?? this.p2pRelayFallbackSecs,
      p2pCacheTtlSecs: p2pCacheTtlSecs ?? this.p2pCacheTtlSecs,
  ...
  Map<String, dynamic> toBackupJson() => {
        ...toSanitizedJson(),
        'relayTokenPresent': relayToken.trim().isNotEmpty,
        'internalTokenPresent': internalToken.trim().isNotEmpty,
      };
