...
class DirectRecipientStore {
  static const int _max = 20;

  static Future<File> _file() async {
    final dir = await getApplicationSupportDirectory();
    return File('${dir.path}${Platform.pathSeparator}direct_recipients.json');
  }
  ...
  static Future<void> add(String recipient) async {
    final r = recipient.trim();
    if (r.isEmpty) return;
    final list = (await read()).toList();
    list.removeWhere((x) => x == r);
    list.insert(0, r);
