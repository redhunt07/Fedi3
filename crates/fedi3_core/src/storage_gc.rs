...
impl Default for StorageConfig {
    fn default() -> Self {
        Self {
            ...
            global_feed_max_items: Some(5000),
            global_feed_ttl_days: Some(7),
            global_feed_prune_batch: Some(1000),
            federated_feed_max_items: Some(5000),
            federated_feed_ttl_days: Some(14),
            federated_feed_prune_batch: Some(1000),
            cache_only_followed_fedi3: Some(true),
            followed_fedi3_object_ttl_days: Some(90),
            other_object_ttl_days: Some(3),
            object_prune_batch: Some(1000),
            media_max_local_cache_bytes: Some(2 * 1024 * 1024 * 1024),
            followed_fedi3_max_objects_per_actor: Some(2000),
            other_max_objects_per_actor: Some(200),
            max_objects_per_actor_batch: Some(2000),
